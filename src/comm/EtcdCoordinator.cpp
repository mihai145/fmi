...
namespace FMI::Comm {
    ...
    void EtcdCoordinator::advertise_own_key(int func_id, int port) {
        ...
        http_post(base_url + "/v3/kv/put", body);
    ...
    void EtcdCoordinator::delete_own_key(int func_id) {
        ...
        http_post(base_url + "/v3/kv/deleterange", body);
        BOOST_LOG_TRIVIAL(info) << "EtcdCoordinator: deleted " << key;
    }

    std::vector<Entry> EtcdCoordinator::fetch_range() {
        ...
        std::string resp = http_post(base_url + "/v3/kv/range", body);
